...
macro(add_component_to_uic PKG_NAME PKG_DESCRIPTION PKG_FILE_NAME PKG_DEPNDS PKG_EXTRA)
  if(NOT APPLE)
...
add_custom_target(
  ...
  COMMAND cd "${DEB_PACKAGE_FOLDER}" && dpkg-scanpackages . /dev/null | gzip -9c > Packages.gz && cd ..
  COMMAND zip -rm "${DEB_PACKAGE_ZIP}" "${DEB_PACKAGE_FOLDER}"
  COMMAND mkdir -p deb-packages && mv "${DEB_PACKAGE_ZIP}" deb-packages
  COMMAND ${CMAKE_COMMAND} -E cmake_echo_color --cyan "Debian packages archived in deb-packages/${DEB_PACKAGE_FOLDER}.zip"
)
