...
pub fn log_data_from_raw(raw_data: Vec<u8>, originator: String) -> Option<String> {
    ...
    if let Some(debug_data) = parse_raw(raw_data) {
        ...
        let content_hex_string = debug_data
            .content
            .iter()
            .fold(String::new(), |acc, &num| acc + &format!("{:02X} ", num));
        let record = format!(
            "[{} {} {} {} {:02X}] [{}] [{}]\n",
...
fn parse_raw(raw_data: Vec<u8>) -> Option<DebugData> {
    ...
    if raw_data.len() != data_len + 2 {
        return None;
    };
    if raw_data[(data_len + 1) as usize] != CLOSE_BRACKET {
        return None;
    };
    // deframed data
    ...
    if raw[0] == 3 {
        ...
        let network_time: u64 = (((raw[9] as u64) << 56)
            ...
            | ((raw[2] as u64) << 0))
            / 1000;
        let debug_type: u16 = ((raw[11] as u16) << 8) | ((raw[10] as u16) << 0);

        // Flag bytes not parsed, reserved for future use
        let seq_number: u16 = ((raw[17] as u16) << 8) | ((raw[16] as u16) << 0);
        ...
        let network_time: u64 = ((raw[7] as u64) << 40)
            ...
            | ((raw[3] as u64) << 8)
            | ((raw[2] as u64) << 0);
        let debug_type: u16 = ((raw[9] as u16) << 8) | ((raw[8] as u16) << 0);
...
fn get_full_debug_type(debug_type: u16) -> (&'static str, u32) {
    match debug_type {
        ...
        PACKET_TRACE => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE as u32,
            )
        }
        ...
        RADIO_REBOOT_COUNT => {
            return (
                "radio_rebo",
                CATEGORY_BACKCHANNEL | RADIO_REBOOT_COUNT as u32,
            )
        }
        ...
        PACKET_TRACE_EM2420_TX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EM2420_TX as u32,
            )
        }
        PACKET_TRACE_EM2420_RX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EM2420_RX as u32,
            )
        }
        PACKET_TRACE_EM2XX_TX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EM2XX_TX as u32,
            )
        }
        PACKET_TRACE_EM2XX_RX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EM2XX_RX as u32,
            )
        }
        PACKET_TRACE_EM3XX_TX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EM3XX_TX as u32,
            )
        }
        PACKET_TRACE_EM3XX_RX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EM3XX_RX as u32,
            )
        }
        PACKET_TRACE_PRO2P_TX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_PRO2P_TX as u32,
            )
        }
        PACKET_TRACE_PRO2P_RX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_PRO2P_RX as u32,
            )
        }
        PACKET_TRACE_PRO2P_OTHER => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_PRO2P_OTHER as u32,
            )
        }
        PACKET_TRACE_EFR_TX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EFR_TX as u32,
            )
        }
        PACKET_TRACE_EFR_RX => {
            return (
                "Packet",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EFR_RX as u32,
            )
        }
        PACKET_TRACE_EFR_OTHER => {
            return (
                "PTI",
                MASK_PACKET | CATEGORY_BACKCHANNEL | PACKET_TRACE_EFR_OTHER as u32,
            )
        }
        FLASH_READ_REQUEST => {
            return (
                "flash_read",
                CATEGORY_BACKCHANNEL | FLASH_READ_REQUEST as u32,
            )
        }
        FLASH_READ_RESPONSE => {
            return (
                "flash_read",
                CATEGORY_BACKCHANNEL | FLASH_READ_RESPONSE as u32,
            )
        }
        EEPROM_READ_REQUEST => {
            return (
                "eeprom_rea",
                CATEGORY_BACKCHANNEL | EEPROM_READ_REQUEST as u32,
            )
        }
        EEPROM_READ_RESPONSE => {
            return (
                "eeprom_rea",
                CATEGORY_BACKCHANNEL | EEPROM_READ_RESPONSE as u32,
            )
        }
        EEPROM_WRITE_REQUEST => {
            return (
                "eeprom_wri",
                CATEGORY_BACKCHANNEL | EEPROM_WRITE_REQUEST as u32,
            )
        }
        EEPROM_WRITE_RESPONSE => {
            return (
                "eeprom_wri",
                CATEGORY_BACKCHANNEL | EEPROM_WRITE_RESPONSE as u32,
            )
        }
        ...
        RAM_READ_RESPONSE => {
            return (
                "ram_read_r",
                CATEGORY_BACKCHANNEL | RAM_READ_RESPONSE as u32,
            )
        }
        RAM_WRITE_REQUEST => {
            return (
                "ram_write_",
                CATEGORY_BACKCHANNEL | RAM_WRITE_REQUEST as u32,
            )
        }
        RAM_WRITE_RESPONSE => {
            return (
                "ram_write_",
                CATEGORY_BACKCHANNEL | RAM_WRITE_RESPONSE as u32,
            )
        }
        ...
        SIMULATED_EZSP_CALLBACK_READY => {
            return (
                "EZSP_RDY",
                CATEGORY_BACKCHANNEL | SIMULATED_EZSP_CALLBACK_READY as u32,
            )
        }
        SIMULATED_WAKEUP_NCP => {
            return (
                "NCP_WAKEUP",
                CATEGORY_BACKCHANNEL | SIMULATED_WAKEUP_NCP as u32,
            )
        }
        SIMULATED_NCP_IS_AWAKE => {
            return (
                "NCP_AWAKE",
                CATEGORY_BACKCHANNEL | SIMULATED_NCP_IS_AWAKE as u32,
            )
        }
        ...
        AEM_SAMPLE => {
            return (
                "AEMSample",
                MASK_AEM | CATEGORY_BACKCHANNEL | AEM_SAMPLE as u32,
            )
        }
        AEM_COUNTER => {
            return (
                "AEMCounter",
                MASK_AEM | CATEGORY_BACKCHANNEL | AEM_COUNTER as u32,
            )
        }
        AEM_REQUEST => {
            return (
                "AEMRequest",
                MASK_AEM | CATEGORY_BACKCHANNEL | AEM_REQUEST as u32,
            )
        }
        AEM_RESPONSE => {
            return (
                "AEMRespons",
                MASK_AEM | CATEGORY_BACKCHANNEL | AEM_RESPONSE as u32,
            )
        }
        AEM_CURRENT_PACKET => {
            return (
                "AEMPacket",
                MASK_AEM | CATEGORY_BACKCHANNEL | AEM_CURRENT_PACKET as u32,
            )
        }
        AEM_CURRENT_PACKET_V2 => {
            return (
                "aem_curren",
                MASK_AEM | CATEGORY_BACKCHANNEL | AEM_CURRENT_PACKET_V2 as u32,
            )
        }
...
mod tests {
    ...
    fn test_invalid_data() {
        ...
        let invalid_data_1: Vec<u8> = vec![
            ...
            0x1C, 0x00, 0x02, 0x00, 0xEB, 0x00, 0x32, 0x13, 0x00, 0x00, 0x2A, 0x00, 0x03, 0xF8,
            0x00, 0x14, 0x32, 0x62, 0xA4, 0x88, 0x21, 0xD1, 0xFA, 0xD5, 0x01, 0x00, 0x16, 0x51,
            0x5D,
        ];

        // Frame with wrong End framing symbol
        let invalid_data_2: Vec<u8> = vec![
            0x5B, 0x1C, 0x00, 0x02, 0x00, 0xEB, 0x00, 0x32, 0x13, 0x00, 0x00, 0x2A, 0x00, 0x03,
            0xF8, 0x00, 0x14, 0x32, 0x62, 0xA4, 0x88, 0x21, 0xD1, 0xFA, 0xD5, 0x01, 0x00, 0x16,
            0x51, 0x5A, // Wrong End framing symbol
        ];

        // Frame with wrong lenght
        let invalid_data_3: Vec<u8> = vec![
            0x5B, 0x1D, 0x00, // Wrong lenght
            0x02, 0x00, 0xEB, 0x00, 0x32, 0x13, 0x00, 0x00, 0x2A, 0x00, 0x03, 0xF8, 0x00, 0x14,
            0x32, 0x62, 0xA4, 0x88, 0x21, 0xD1, 0xFA, 0xD5, 0x01, 0x00, 0x16, 0x51, 0x5D,
        ];
    ...
    fn test_v2_v3_debug_data() {
        ...
        let raw_data_v2: Vec<u8> = vec![
            ...
            0x1C,
            0x00, // Lenght includes everything except the framing '[' and ']' characters.
            0x02, 0x00, // Version
        ...
        let raw_data_v3: Vec<u8> = vec![
            ...
            0x00, // Lenght includes everything except the framing '[' and ']' characters.
            0x03, 0x00, // Version
            0xF8, 0x95, 0x53, 0xFB, 0x4A, 0x00, 0x00,
            0x00, // Timestamp 0x4AFB5395F8/1000 = 322044139
            0x2A, 0x00, // Debug type
