 ...
 * 
 * @param[out] locator locator JSON object.
 * @param[in]  locator_id Id of the locator to search for.
 * 
 * @retval SL_STATUS_NOT_INITIALIZED - Module not initialized.
 * @retval SL_STATUS_NOT_FOUND - Locator config not found.
 * @retval SL_STATUS_OK - Locator config found.
 *****************************************************************************/
sl_status_t aoa_parse_find_locator_config(cJSON **locator,
                                          aoa_id_t locator_id);
