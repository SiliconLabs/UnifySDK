...
class UserCredentialAttrs extends CommandAttrs  {
    ...
    getAvailableSlots(userCredentials: any, currentUser: any, credentialType: any) {
        var availableSlot = [];
        ...
        var credentials = userCredentials.User[currentUser]?.Credential || {};
    ...
    getDefinedSlots(userCredential: any, currentUser: any, credentialType: any) {
        var credentials = userCredential.User[currentUser]?.Credential || {};
        var currentUserSlots = credentials[credentialType] || {};
