  ...
  getSupportedCredentialType(credentialsTypes: any, credentialRules: any) {
    return (credentialsTypes != null ? <div>
      {Object.entries(credentialsTypes).map(([credentialsType, supported]) => {
        ...
        var crbSupport = currentCredentialRule.ReadBackSupport?.Reported;
        ...
        <Badge pill variant="primary" key={credentialsType}>
          <Tooltip title={["CRB Support : " + crbSupport, <br/>, "Supported Slot Count : " + supportedSlotCount, <br/>, "Credential Min Length : " + credMinLength, <br/>, "Credential Max Length : " + credMaxLength]}>
