...
/**
 * e_zcl_cluster_role
 * @brief An enum representing the role of the endpoint on the network
**/
enum e_zcl_cluster_role { ZCL_SERVER_ROLE = 0, ZCL_CLIENT_ROLE = 1 };
