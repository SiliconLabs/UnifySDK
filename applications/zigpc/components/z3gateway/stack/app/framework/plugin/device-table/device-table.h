...
#ifndef EMBER_AF_PLUGIN_DEVICE_TABLE_CLUSTER_SIZE
#define EMBER_AF_PLUGIN_DEVICE_TABLE_CLUSTER_SIZE 20
#endif

#ifndef EMBER_AF_PLUGIN_DEVICE_TABLE_MAX_ENDPOINT_SIZE
#define EMBER_AF_PLUGIN_DEVICE_TABLE_MAX_ENDPOINT_SIZE 20
#endif
...
#ifndef EMBER_AF_PLUGIN_DEVICE_TABLE_DEVICE_TABLE_SIZE
 ...
 */
void emberAfDeviceTableSend(const EmberEUI64 eui64, uint8_t endpoint);
 ...
 * @param endpoint  The endpoint of the device to which to send the command.
 */
void emberAfDeviceTableCommandSendWithEndpoint(const EmberEUI64 eui64,
                                               uint8_t endpoint);
 ...
 */
uint16_t emberAfDeviceTableGetIndexFromEui64AndEndpoint(const EmberEUI64 eui64,
                                                        uint8_t endpoint);
 ...
 * @return EmberStatus EMBER_SUCCESS or EMBER_NOT_FOUND if the device is
...
/**
 * @brief Start device discovery for end device to get active endpoint
 * count and detailed endpoint information. If the EUI64 has not joined
 * the network, the device discovery will not run.
 *
 * @param eui64 EUI of the node to start discovering.
 * @return EmberStatus EMBER_SUCCESS or EMBER_NOT_FOUND if the device is
 * not part of the network
 */
