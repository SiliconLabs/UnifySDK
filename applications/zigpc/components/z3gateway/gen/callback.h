 ...
 * @param endpoint   Ver.: since 20201215
 */
void emberAfPluginDeviceTableNewDeviceCallback(const EmberEUI64 eui64, uint8_t endpoint);
/** @brief Rejoin device
 *
 ...
 * @param endpoint   Ver.: since 20201215
 */
void emberAfPluginDeviceTableRejoinDeviceCallback(const EmberEUI64 newNodeEui64, uint8_t endpoint);
/*
 *
