...
class zigpc_used_virtual_ram_metric : public zigpc_diagnostics_metric
{
  private:
  long long value;

  public:
  zigpc_used_virtual_ram_metric(zigpc_diagnostics_notification &notif,
