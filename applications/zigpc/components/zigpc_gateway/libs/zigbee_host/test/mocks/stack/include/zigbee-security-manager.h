 ...
 */
sl_status_t sl_zb_sec_man_import_key(sl_zigbee_sec_man_context_t* context,
 ...
 * other metadata.
 */
sl_status_t sl_zb_sec_man_export_link_key_by_eui(sl_802154_long_addr_t eui,
                                                 sl_zigbee_sec_man_context_t* context,
                                                 sl_zigbee_sec_man_key_t* plaintext_key,
                                                 sl_zigbee_sec_man_aps_key_metadata_t* key_data);
 ...
 */
bool sl_zb_sec_man_have_link_key(sl_802154_long_addr_t eui);
 ...
 */
#define sl_zigbee_sec_man_import_transient_key(eui64, key) zb_sec_man_import_transient_key(eui64, key, ZB_SEC_MAN_FLAG_NONE)
 ...
 */
sl_status_t sl_zb_sec_man_export_transient_key_by_eui(sl_802154_long_addr_t eui64,
                                                      sl_zigbee_sec_man_context_t* context,
                                                      sl_zigbee_sec_man_key_t* plaintext_key,
                                                      sl_zigbee_sec_man_aps_key_metadata_t* key_data);
 ...
 */
sl_status_t sl_zb_sec_man_delete_transient_key(sl_zigbee_sec_man_context_t* context);
 ...
 * @return sl_status_t SL_STATUS_OK upon success, an error code otherwise.
 */
sl_status_t sl_zb_sec_man_delete_key_table_key(sl_zigbee_sec_man_context_t* context);
 ...
 * @return sl_status_t SL_STATUS_OK upon success, SL_STATUS_NOT_FOUND otherwise.
 */
sl_status_t sl_zb_sec_man_check_key_context(sl_zigbee_sec_man_context_t* context);
 ...
 *
 */
sl_status_t sl_zb_sec_man_get_network_key_info(sl_zigbee_sec_man_network_key_info_t* network_key_info);
 ...
 */
sl_status_t sl_zb_sec_man_get_aps_key_info(sl_zigbee_sec_man_context_t* context,
                                           sl_zigbee_sec_man_aps_key_metadata_t* key_data);
 ...
 * @return sl_status_t SL_STATUS_OK upon success, an error code otherwise.
 */
sl_status_t sl_zb_sec_man_delete_key(sl_zigbee_sec_man_context_t* context);
 ...
 */
sl_status_t sl_zb_sec_man_load_key_context(sl_zigbee_sec_man_context_t* context);
 ...
 */
uint8_t sl_zb_sec_man_find_symmetric_passphrase_key_table_index(sl_802154_long_addr_t address);
 ...
 */
sl_status_t sl_zb_sec_man_export_symmetric_passphrase(sl_802154_long_addr_t address,
                                                      sl_zigbee_key_data_t* key_data);
 ...
 */
sl_status_t sl_zb_sec_man_update_symmetric_passphrase_eui(sl_802154_long_addr_t old_eui64,
 ...
 */
bool sl_zb_sec_man_compare_key_to_value(sl_zigbee_sec_man_context_t* context, const sl_zigbee_sec_man_key_t* test_key);
...
void sl_zb_sec_man_set_context_aes_ecb_alg(sl_zigbee_sec_man_context_t* context);
void sl_zb_sec_man_set_context_extended_ccm_alg(sl_zigbee_sec_man_context_t* context);
...
#define emberImportLinkKey sl_zigbee_sec_man_import_link_key
