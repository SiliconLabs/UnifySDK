...
// <o SL_ZIGBEE_AF_PLUGIN_GATEWAY_MAX_FDS> Max File Descriptors to Monitor <3-255>
// <i> Default: 10
// <i> The maximum number of file descriptors that the gateway application can monitor for activity with select().
#define SL_ZIGBEE_AF_PLUGIN_GATEWAY_MAX_FDS   10

// <o SL_ZIGBEE_AF_PLUGIN_GATEWAY_TCP_PORT_OFFSET> TCP Port Offset <1-65535>
// <i> Default: 4900
...
#define SL_ZIGBEE_AF_PLUGIN_GATEWAY_TCP_PORT_OFFSET   4900

// <o SL_ZIGBEE_AF_PLUGIN_GATEWAY_MAX_WAIT_FOR_EVENT_TIMEOUT_MS> Maximum Time to Wait for Events (milliseconds) <1-4294967295>
...
#define SL_ZIGBEE_AF_PLUGIN_GATEWAY_MAX_WAIT_FOR_EVENT_TIMEOUT_MS   0xA
