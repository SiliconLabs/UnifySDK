...
void test_zigpc_attrmgmt_add_poll_entry_succeeds()
{
  ...
  add_status = zigpc_attrmgmt_add_poll_entry(expect_eui64,
                                             expect_endpoint_id,
                                             expect_cluster_id);

  unsigned int test_size = zigpc_attrmgmt_get_poll_list_current_size();

  unsigned int test_max_size = zigpc_attrmgmt_get_poll_list_max_size();

  zigbee_eui64_uint_t test_eui64        = 0;
  zigbee_endpoint_id_t test_endpoint_id = 0;
  zcl_cluster_id_t test_cluster_id      = 0;

  sl_status_t get_status = zigpc_attrmgmt_get_next_poll_entry(test_eui64,
                                                              test_endpoint_id,
                                                              test_cluster_id);

  zigbee_eui64_uint_t expect_eui64_uint = zigbee_eui64_to_uint(expect_eui64);
...
void test_zigpc_attrmgmt_remove_poll_entry_succeeds()
{
  ...
  zigbee_eui64_t dummy_eui64 = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  ...
  sl_status_t add_status = zigpc_attrmgmt_add_poll_entry(expect_eui64,
                                                         expect_endpoint_id,
                                                         expect_cluster_id);

  add_status = zigpc_attrmgmt_add_poll_entry(dummy_eui64,
                                             expect_endpoint_id,
                                             expect_cluster_id);
  add_status = zigpc_attrmgmt_add_poll_entry(dummy1_eui64,
                                             expect_endpoint_id,
                                             expect_cluster_id);
  add_status = zigpc_attrmgmt_add_poll_entry(dummy2_eui64,
                                             expect_endpoint_id,
                                             expect_cluster_id);
  ...
  sl_status_t remove_status
    = zigpc_attrmgmt_remove_poll_entry(dummy1_eui64,
                                       expect_endpoint_id,
                                       expect_cluster_id);

  test_size = zigpc_attrmgmt_get_poll_list_current_size();
...
void test_zigpc_attrmgmt_send_poll_increments_list_resets()
{
  sl_status_t add_status     = SL_STATUS_OK;
  sl_status_t send_status    = SL_STATUS_OK;
  zigbee_eui64_t dummy_eui64 = {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10};
  zigbee_eui64_t dummy1_eui64
    = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01};
  zigbee_eui64_t dummy2_eui64
    = {0x02, 0x02, 0x02, 0x02, 0x0A, 0x4C, 0x99, 0x10};
...
void test_zigpc_attrmgmt_poll_sends_read_attribute_cmd(void)
{
  ...
  zigpc_zclprofiles_get_cluster_attribute_list_ExpectAndReturn(
    expect_cluster_id,
    NULL,
    SL_STATUS_OK);
