...
#ifndef ZWAVE_COMMAND_CLASS_MANUFACTURER_SPECIFIC_H
#define ZWAVE_COMMAND_CLASS_MANUFACTURER_SPECIFIC_H

#include "sl_status.h"
#include "zwave_rx.h"

/**
 * @brief setup for manufacturer specific command class
 *
 * This setup will register the manufacturer specific command handler
...
/**
 * @brief Handles incoming manufacturer specific encapsulated commands
 *
...
#endif  //ZWAVE_COMMAND_CLASS_MANUFACTURER_SPECIFIC_H
