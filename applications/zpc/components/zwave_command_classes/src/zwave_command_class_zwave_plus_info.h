...
#ifndef ZWAVE_COMMAND_CLASS_ZWAVE_PLUS_INFO_H
#define ZWAVE_COMMAND_CLASS_ZWAVE_PLUS_INFO_H
...
/**
 * @brief setup for Zwave Plus Info command class
 *
...
/**
 * @brief Handles incoming Zwave Plus Info commands
 *
...
#endif  //ZWAVE_COMMAND_CLASS_ZWAVE_PLUS_INFO_H
