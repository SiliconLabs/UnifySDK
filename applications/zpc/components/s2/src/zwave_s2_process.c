...
{
  // Register our s2 transport component such that we get the incoming s2 frames
  // via the zwave_s2_on_frame_received. We also use the
  // zwave_s2_on_new_network_entered update our internal home id and node id
  // cache, this is needed to keep us up to date with when doing a set default.
  // TODO: replace this by a transport plugin system
