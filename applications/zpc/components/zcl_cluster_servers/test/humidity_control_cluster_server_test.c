...
uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback_t
  uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback;

uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback_t
  uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback;
  

void uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback_set_stub(
  const uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback_t callback,
  int cmock_num_calls)
{
  uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback = callback;
}

void uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback_set_stub(
  const uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback_t
    callback,
  int cmock_num_calls)
{
  uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback= callback;
}
...
void setUp()
{
  ...
  uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback_set_Stub(
    &uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback_set_stub);
  uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback_set_Stub(
    &uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback_set_stub);
...
{
  TEST_ASSERT_NOT_NULL(uic_mqtt_dotdot_z_wave_humidity_control_mode_set_callback);
  ...
  TEST_ASSERT_EQUAL_MESSAGE(
    SL_STATUS_OK,
    attribute_store_get_desired(current_mode_node, &current_mode, sizeof(current_mode)),
...
{
  TEST_ASSERT_NOT_NULL(uic_mqtt_dotdot_z_wave_humidity_control_setpoint_set_callback);
  ...
  humidity_control_setpoint_type_t expected_type = expected_setpoint_type_ucl + 1;
