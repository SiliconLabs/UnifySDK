...
/**
 * @defgroup user_code_cluster_server User Code Cluster Server
 * @ingroup zcl_cluster_servers
 * @brief The module handlers the User Code command mapping
 * @{
 */

#ifndef USER_CODE_CLUSTER_SERVER_H
#define USER_CODE_CLUSTER_SERVER_H
...
#endif  //USER_CODE_CLUSTER_SERVER_H
/** @} end user_code_cluster_server */
