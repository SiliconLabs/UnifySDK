...
/**
 * @file zwave_rx_zwapi_callbacks.h
 * @brief List of Z-Wave RX callbacks that are registered to the \ref ZWAPI
 * and used to call Z-Wave RX callbacks ( \ref zwave_rx ).
 *
 * These callbacks are an intermediate step between the \ref ZWAPI and the
 ...
 * \ref ZWAPI controller libraries will call this function for incoming
 ...
 * \ref ZWAPI Bridge libraries will call this function instead of
