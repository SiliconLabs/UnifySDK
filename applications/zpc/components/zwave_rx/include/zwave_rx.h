 ...
 * @ingroup components
 * @brief Component responsible for initializing the \ref ZWAPI, listening to
 * incoming frames, and dispatching them.
 *
 * This component is composed of 2 sub-parts:
 * 1. \ref zwave_rx_fixt : This part is responsible for the \ref ZWAPI
 ...
 * (FIXME: UIC-95) component handling de-encapsulation of incoming Z-Wave
