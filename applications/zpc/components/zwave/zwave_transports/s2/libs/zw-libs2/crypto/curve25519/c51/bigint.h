...
uint8_t bigint_add(uint8_t  *r, const uint8_t  *a, const uint8_t  *b, uint8_t len);

uint8_t bigint_sub(uint8_t  *r, const uint8_t  *a, const uint8_t  *b, uint8_t len);
...
void bigint_cmov(uint8_t  *r, const uint8_t  *x, uint8_t b, uint8_t len);
