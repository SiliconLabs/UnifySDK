...
/**
 * @defgroup unify_stdin_attribute_poll_command_handler Unfiy Attribute Store Commands
 * @ingroup uic_stdin
...
#ifndef UNIFY_STDIN_ATTRIBUTE_POLL_COMMAND_HANDLER_H
#define UNIFY_STDIN_ATTRIBUTE_POLL_COMMAND_HANDLER_H
...
#endif
/** @} end unify_stdin_attribute_poll_command_handler */
