...
unsafe extern "C" fn message_callback(
    ...
    let msg = MosqMessage::new(topic.into_owned(), message.into_owned());
...
mod tests {
    ...
    fn test_topic_matcher() {
        ...
        let mes = MosqMessage::new(
            "ucl/by-unid/hello/are/you/here".to_string(),
            "This is the payload".to_string(),
        );

        let mes_2 = MosqMessage::new(
            "ucl/hello/are/you/here".to_string(),
            "This is the payload".to_string(),
        );
        ...
        let mes = MosqMessage::new(
            "ucl/by-unid/hello/test".to_string(),
            "This is the payload".to_string(),
        );

        let mes_2 = MosqMessage::new(
            "ucl/by-unid/hello/test/test_2".to_string(),
            "This is the payload".to_string(),
        );
