...
void uic_mqtt_dotdot_z_wave_humidity_control_publish_mode_set_command(
  ...
  std::string topic = "ucl/by-unid/"+ std::string(destination_unid) + "/ep" +
                      std::to_string(destination_endpoint) + "/";
  topic += "ZWaveHumidityControl/Commands/ModeSet";
...
void uic_mqtt_dotdot_z_wave_humidity_control_publish_mode_set_command_to_group(
  ...
  // Create the topic
  std::string topic = "ucl/by-group/"+ std::to_string(destination_group_id) +
                      "/ZWaveHumidityControl/Commands/ModeSet";
...
void uic_mqtt_dotdot_z_wave_humidity_control_publish_setpoint_set_command(
  ...
  std::string topic = "ucl/by-unid/"+ std::string(destination_unid) + "/ep" +
                      std::to_string(destination_endpoint) + "/";
  topic += "ZWaveHumidityControl/Commands/SetpointSet";
...
void uic_mqtt_dotdot_z_wave_humidity_control_publish_setpoint_set_command_to_group(
  ...
  // Create the topic
  std::string topic = "ucl/by-group/"+ std::to_string(destination_group_id) +
                      "/ZWaveHumidityControl/Commands/SetpointSet";
