 ...
 * the ZWaveHumidityControl cluster.
 *
 * Publication will be made at the following topic
 * ucl/by-unid/UNID/epID/ZWaveHumidityControl/GeneratedCommands/ModeSet
 *
 * @param unid      The UNID of the node that sent us the command.
 * 
 * @param endpoint  The Endpoint ID of the node that sent us the command.
 ...
 * 
 */
void uic_mqtt_dotdot_z_wave_humidity_control_publish_generated_mode_set_command(
  const dotdot_unid_t unid,
  const dotdot_endpoint_id_t endpoint,
  ...
  std::string topic = "ucl/by-unid/"+ std::string(unid) + "/ep" +
                      std::to_string(endpoint) + "/";
  topic += "ZWaveHumidityControl/GeneratedCommands/ModeSet";

  std::string payload =
    get_json_payload_for_z_wave_humidity_control_mode_set_command(
    fields);
 ...
 *
 * Publication will be made at the following topic
 * ucl/by-unid/UNID/epID/ZWaveHumidityControl/GeneratedCommands/SetpointSet
 *
 * @param unid      The UNID of the node that sent us the command.
 * 
 * @param endpoint  The Endpoint ID of the node that sent us the command.
 ...
 * 
 */
void uic_mqtt_dotdot_z_wave_humidity_control_publish_generated_setpoint_set_command(
  const dotdot_unid_t unid,
  const dotdot_endpoint_id_t endpoint,
  ...
  std::string topic = "ucl/by-unid/"+ std::string(unid) + "/ep" +
                      std::to_string(endpoint) + "/";
  topic += "ZWaveHumidityControl/GeneratedCommands/SetpointSet";

  std::string payload =
    get_json_payload_for_z_wave_humidity_control_setpoint_set_command(
    fields);
 ...
 *
 * Publication will be made at the following topic
 * ucl/by-unid/UNID/epID/ZWaveHumidityControl/GeneratedCommands/WriteAttributes
 *
 * @param unid      The UNID of the node that sent us the command.
 * 
 * @param endpoint  The Endpoint ID of the node that sent us the command.
 ...
 * @param attribute_list    List of attributes that are written
 */
void uic_mqtt_dotdot_z_wave_humidity_control_publish_generated_write_attributes_command(
  const dotdot_unid_t unid,
  const dotdot_endpoint_id_t endpoint,
  uic_mqtt_dotdot_z_wave_humidity_control_state_t attribute_values,
  uic_mqtt_dotdot_z_wave_humidity_control_updated_state_t attribute_list
){
  // Create the topic
  std::string topic = "ucl/by-unid/"+ std::string(unid) + "/ep" +
                      std::to_string(endpoint) + "/";
  topic += "ZWaveHumidityControl/GeneratedCommands/WriteAttributes";
  ...
  json_object["ReportingMode"] = z_wave_humidity_control_reporting_mode_get_enum_value_name((uint32_t)attribute_values.reporting_mode);
  #else
  json_object["ReportingMode"] = static_cast<ModeType>(attribute_values.reporting_mode);
  #endif
