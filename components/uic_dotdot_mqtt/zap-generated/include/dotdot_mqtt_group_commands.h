...
/**
 * @brief Callback signature for by-group ZWaveHumidityControl::ModeSet command.
 */
typedef void (*uic_mqtt_dotdot_by_group_z_wave_humidity_control_mode_set_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/ZWaveHumidityControl/mode_set is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group ZWaveHumidityControl::SetpointSet command.
 */
typedef void (*uic_mqtt_dotdot_by_group_z_wave_humidity_control_setpoint_set_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/ZWaveHumidityControl/setpoint_set is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
typedef void (*uic_mqtt_dotdot_by_group_z_wave_humidity_control_write_attributes_callback_t)(
    const dotdot_group_id_t group_id,
    uic_mqtt_dotdot_z_wave_humidity_control_state_t,
    uic_mqtt_dotdot_z_wave_humidity_control_updated_state_t
);

/**
 * Setup a callback for WriteAttribute to be called when a
 * ucl/by-group/+/z_wave_humidity_control/Commands/WriteAttributes is received.
 * Setting this callback will overwrite any previously set callback.
 */
