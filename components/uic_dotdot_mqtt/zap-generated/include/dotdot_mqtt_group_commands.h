...
/**
 * @brief Callback signature for by-group OTAUpgrade::ImageNotify command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_image_notify_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/image_notify is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::QueryNextImageRequest command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_query_next_image_request_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/query_next_image_request is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::QueryNextImageResponse command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_query_next_image_response_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/query_next_image_response is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::ImageBlockRequest command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_image_block_request_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/image_block_request is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::ImagePageRequest command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_image_page_request_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/image_page_request is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::ImageBlockResponse command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_image_block_response_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/image_block_response is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::UpgradeEndRequest command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_upgrade_end_request_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/upgrade_end_request is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::UpgradeEndResponse command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_upgrade_end_response_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/upgrade_end_response is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::QueryDeviceSpecificFileRequest command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_query_device_specific_file_request_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/query_device_specific_file_request is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
/**
 * @brief Callback signature for by-group OTAUpgrade::QueryDeviceSpecificFileResponse command.
 */
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_query_device_specific_file_response_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup handler to be called when a
 * ucl/by-group/+/OTAUpgrade/query_device_specific_file_response is received.
 * Setting this callback will overwrite the previous set callback.
 *
 */
...
typedef void (*uic_mqtt_dotdot_by_group_ota_upgrade_write_attributes_callback_t)(
    const dotdot_group_id_t group_id,
...
/**
 * Setup a callback for WriteAttribute to be called when a
 * ucl/by-group/+/ota_upgrade/Commands/WriteAttributes is received.
 * Setting this callback will overwrite any previously set callback.
 */
