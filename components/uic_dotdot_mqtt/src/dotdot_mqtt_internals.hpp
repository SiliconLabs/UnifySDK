...
/**
 * @defgroup dotdot_mqtt_internals Dotdot MQTT internal shared functions
 * @ingroup dotdot_mqtt
...
#ifndef DOTDOT_MQTT_INTERNALS_HPP
#define DOTDOT_MQTT_INTERNALS_HPP
...
#endif  //DOTDOT_MQTT_INTERNALS_HPP
/** @} end dotdot_mqtt_internals */
