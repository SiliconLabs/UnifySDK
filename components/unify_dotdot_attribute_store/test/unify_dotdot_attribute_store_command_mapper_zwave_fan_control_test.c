...
uic_mqtt_dotdot_fan_control_set_fan_mode_callback_t
...
void test_zwave_fan_control_no_get_endpoint_function_registered()
{
  ...
  uic_mqtt_dotdot_fan_control_set_fan_mode_callback
    = get_uic_mqtt_dotdot_fan_control_set_fan_mode_callback();
  TEST_ASSERT_EQUAL(SL_STATUS_FAIL,
                    uic_mqtt_dotdot_fan_control_set_fan_mode_callback(
                      expected_unid,
                      expected_endpoint_id,
                      UIC_MQTT_DOTDOT_CALLBACK_TYPE_SUPPORT_CHECK,
                      ZCL_ZWAVE_CLUSTER_FAN_MODE_AUTO_HIGH));
...
void test_zwave_fan_control_set_fan_mode_command_support()
{
  ...
  TEST_ASSERT_NOT_NULL(
    uic_mqtt_dotdot_fan_control_set_fan_mode_callback_set);
  ...
  // Add the DOTDOT_ATTRIBUTE_ID_FAN_CONTROL_Z_WAVE_FAN_MODE attribute
  attribute_store_add_node(DOTDOT_ATTRIBUTE_ID_FAN_CONTROL_Z_WAVE_FAN_MODE,
...
void test_zwave_fan_control_set_fan_mode_command_update_desired()
{
  ...
  // Add attributes
  attribute_store_node_t fan_control_node
    = attribute_store_add_node(DOTDOT_ATTRIBUTE_ID_FAN_CONTROL_Z_WAVE_FAN_MODE,
                               attribute_store_get_root());
  zwave_cluster_fan_mode value = ZCL_ZWAVE_CLUSTER_FAN_MODE_LOW;
  ...
  TEST_ASSERT_EQUAL(ZCL_ZWAVE_CLUSTER_FAN_MODE_LOW,
                    dotdot_get_fan_control_z_wave_fan_mode(expected_unid,
                                                           expected_endpoint_id,
                                                           DESIRED_ATTRIBUTE));
