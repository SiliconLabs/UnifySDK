...
// Commands for cluster: TouchlinkCommissioning
#define DOTDOT_TOUCHLINK_COMMISSIONING_SCAN_REQUEST_COMMAND_ID (0x0)
#define DOTDOT_TOUCHLINK_COMMISSIONING_SCAN_RESPONSE_COMMAND_ID (0x1)
#define DOTDOT_TOUCHLINK_COMMISSIONING_DEVICE_INFORMATION_REQUEST_COMMAND_ID (0x2)
#define DOTDOT_TOUCHLINK_COMMISSIONING_DEVICE_INFORMATION_RESPONSE_COMMAND_ID (0x3)
#define DOTDOT_TOUCHLINK_COMMISSIONING_IDENTIFY_REQUEST_COMMAND_ID (0x6)
#define DOTDOT_TOUCHLINK_COMMISSIONING_RESET_TO_FACTORY_NEW_REQUEST_COMMAND_ID (0x7)
#define DOTDOT_TOUCHLINK_COMMISSIONING_NETWORK_START_REQUEST_COMMAND_ID (0x10)
#define DOTDOT_TOUCHLINK_COMMISSIONING_NETWORK_START_RESPONSE_COMMAND_ID (0x11)
#define DOTDOT_TOUCHLINK_COMMISSIONING_NETWORK_JOIN_ROUTER_REQUEST_COMMAND_ID (0x12)
#define DOTDOT_TOUCHLINK_COMMISSIONING_NETWORK_JOIN_ROUTER_RESPONSE_COMMAND_ID (0x13)
#define DOTDOT_TOUCHLINK_COMMISSIONING_NETWORK_JOIN_END_DEVICE_REQUEST_COMMAND_ID (0x14)
#define DOTDOT_TOUCHLINK_COMMISSIONING_NETWORK_JOIN_END_DEVICE_RESPONSE_COMMAND_ID (0x15)
#define DOTDOT_TOUCHLINK_COMMISSIONING_NETWORK_UPDATE_REQUEST_COMMAND_ID (0x16)
#define DOTDOT_TOUCHLINK_COMMISSIONING_ENDPOINT_INFORMATION_COMMAND_ID (0x40)
#define DOTDOT_TOUCHLINK_COMMISSIONING_GET_GROUP_IDENTIFIERS_REQUEST_COMMAND_ID (0x41)
#define DOTDOT_TOUCHLINK_COMMISSIONING_GET_GROUP_IDENTIFIERS_RESPONSE_COMMAND_ID (0x41)
#define DOTDOT_TOUCHLINK_COMMISSIONING_GET_ENDPOINT_LIST_REQUEST_COMMAND_ID (0x42)
#define DOTDOT_TOUCHLINK_COMMISSIONING_GET_ENDPOINT_LIST_RESPONSE_COMMAND_ID (0x42)
