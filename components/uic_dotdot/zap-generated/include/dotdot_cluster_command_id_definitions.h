...
// Commands for cluster: ZWaveHumidityControl
#define DOTDOT_Z_WAVE_HUMIDITY_CONTROL_MODE_SET_COMMAND_ID (0x1)
#define DOTDOT_Z_WAVE_HUMIDITY_CONTROL_SETPOINT_SET_COMMAND_ID (0x1)
