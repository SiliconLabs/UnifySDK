...
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_PENDING_HEAT (128)
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_PENDING_HEAT_OFFSET (7)
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_PENDING_COOL (256)
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_PENDING_COOL_OFFSET (8)
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_VENT_ECONOMIZER (512)
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_VENT_ECONOMIZER_OFFSET (9)
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_AUX_HEATING (1024)
#define THERMOSTAT_THERMOSTAT_RUNNING_STATE_AUX_HEATING_OFFSET (10)
