...
// Enum for FanControlZWaveFanState
typedef enum {
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_IDLE = 0,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_RUNNING = 1,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_RUNNING_HIGH = 2,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_RUNNING_MEDIUM = 3,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_CIRCULATION = 4,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_HUMIDITY_CIRCULATION = 5,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_RIGHT_LEFT_CIRCULATION = 6,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_UP_DOWN_CIRCULATION = 7,
  ZCL_FAN_CONTROL_Z_WAVE_FAN_STATE_QUIET_CIRCULATION = 8,
} FanControlZWaveFanState;
...
// Enum for zwave_cluster_fan_mode
typedef enum {
  ZCL_ZWAVE_CLUSTER_FAN_MODE_AUTO = 0,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_LOW = 1,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_AUTO_HIGH = 2,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_HIGH = 3,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_AUTO_MEDIUM = 4,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_MEDIUM = 5,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_CIRCULATION = 6,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_HUMIDITY_CIRCULATION = 7,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_LEFT_RIGHT = 8,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_UP_DOWN = 9,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_QUIET = 10,
  ZCL_ZWAVE_CLUSTER_FAN_MODE_EXTERNAL_CIRCULATION = 11,
} zwave_cluster_fan_mode;
...
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_AUTO (1)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_AUTO_OFFSET (0)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_LOW (2)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_LOW_OFFSET (1)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_AUTO_HIGH (4)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_AUTO_HIGH_OFFSET (2)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_HIGH (8)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_HIGH_OFFSET (3)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_AUTO_MEDIUM (16)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_AUTO_MEDIUM_OFFSET (4)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_MEDIUM (32)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_MEDIUM_OFFSET (5)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_CIRCULATION (64)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_CIRCULATION_OFFSET (6)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_HUMIDITY_CIRCULATION (128)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_HUMIDITY_CIRCULATION_OFFSET (7)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_LEFT_RIGHT (256)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_LEFT_RIGHT_OFFSET (8)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_UP_DOWN (512)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_UP_DOWN_OFFSET (9)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_QUIET (1024)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_QUIET_OFFSET (10)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_EXTERNAL_CIRCULATION (2048)
#define FAN_CONTROL_Z_WAVE_SUPPORTED_FAN_MODE_EXTERNAL_CIRCULATION_OFFSET (11)
