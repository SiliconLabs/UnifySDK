...
// Enum for ZWaveHumidityControlCurrentState
typedef enum {
  ZCL_Z_WAVE_HUMIDITY_CONTROL_CURRENT_STATE_IDLE = 0,
  ZCL_Z_WAVE_HUMIDITY_CONTROL_CURRENT_STATE_HUMIDIFYING = 1,
  ZCL_Z_WAVE_HUMIDITY_CONTROL_CURRENT_STATE_DEHUMIDIFYING = 2,
} ZWaveHumidityControlCurrentState;
...
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_REPORTING_MODE_HUMIDIFY (1)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_REPORTING_MODE_HUMIDIFY_OFFSET (0)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_REPORTING_MODE_DEHUMIDIFY (2)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_REPORTING_MODE_DEHUMIDIFY_OFFSET (1)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_REPORTING_MODE_AUTO (4)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_REPORTING_MODE_AUTO_OFFSET (2)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_SET_POINTS_HUMIDIFIER (1)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_SET_POINTS_HUMIDIFIER_OFFSET (0)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_SET_POINTS_DEHUMIDIFIER (2)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_SET_POINTS_DEHUMIDIFIER_OFFSET (1)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_SET_POINTS_AUTO (4)
#define Z_WAVE_HUMIDITY_CONTROL_SUPPORTED_SET_POINTS_AUTO_OFFSET (2)
